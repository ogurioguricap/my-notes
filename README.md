...
│   ├── test-notebook.mjs       GoodNotes 模式实测（笔记本 / 页面 / 四种笔 / 闪卡 / 录音转写·分段锚定 / PDF 文字层·目录页·内链·阅读版 / 长图 / 批量导出 / OCR 定位与选区 / 模板库 / Markdown 导出 / 手势，339 项断言）
...
| 11 | GoodNotes 模式实测 339 项断言（笔记本 / 页面 / 四种笔 / 闪卡 / 录音转写与分段锚定 / PDF 画质·文字层·目录页·内链·阅读版 / 长图 / 批量导出 / OCR 定位与选区 / 模板库 / Markdown 导出 / 手势） | **中止** |
