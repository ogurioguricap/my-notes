...
> 这一层的底线由 **405 项断言**守着（`tools/test-notebook.mjs`）：数据层（页面管理 / 垃圾桶 / 闪卡间隔 / 录音锚点 / 备份导入导出 / 老数据迁移）、
...
| 11 | GoodNotes 模式实测 405 项断言（笔记本 / 页面 / 四种笔 / 闪卡 / 录音转写·分片·分段锚定 / 页面朗读 / PDF 画质·文字层·目录页（含层级）·内链·阅读版 / 长图 / 批量导出 / EPUB·单文件 HTML / OCR 定位·选区·原位替换 / 封面图 / 今日复习 / 命中高亮 / 模板库 / Markdown 导出 / 手势） | **中止** |
