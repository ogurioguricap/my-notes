...
| **移动端手感** | 手机（≤860px）上工具条变**两段式**：常用工具一排，点「⋯」展开贴纸 / 胶带 / 激光笔 / 尺子；**双指捏合**缩放页面（0.4×~4×，捏合时不落笔）；**长按画笔/荧光笔**循环切换笔型（圆珠笔 → 钢笔 → 毛笔 → 铅笔） |
...
│   ├── test-notebook.mjs       GoodNotes 模式实测（笔记本 / 页面 / 四种笔 / 闪卡 / 录音 / PDF 文字层·目录·画质 / 长图 / 批量导出 / OCR 定位与选区 / 模板库 / Markdown 导出 / 手势，284 项断言）
...
| 11 | GoodNotes 模式实测 284 项断言（笔记本 / 页面 / 四种笔 / 闪卡 / 录音 / PDF 画质·文字层·目录 / 长图 / 批量导出 / OCR 定位与选区 / 模板库 / Markdown 导出 / 同步 / 手势） | **中止** |
