...
│   ├── test-notebook.mjs       GoodNotes 模式实测（笔记本 / 页面 / 四种笔 / 闪卡 / 录音 / PDF 画质·文字层·合成 / 批量导出 / OCR / 同步，223 项断言）
...
| 11 | GoodNotes 模式实测 223 项断言（笔记本 / 页面 / 四种笔 / 闪卡 / 录音 / PDF 画质·文字层·合成 / 批量导出 / OCR / 同步 / 裁剪） | **中止** |
